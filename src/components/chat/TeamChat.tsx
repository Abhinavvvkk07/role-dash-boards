...
export function TeamChat({ variant = 'default', className = '', height = 'calc(100vh-8rem)' }: TeamChatProps) {
  ...
  return (
    <div className={`${className}`} style={{ height }}>
      <div className="grid grid-cols-12 h-full gap-4">
        {/* Sidebar */}
        <div className={`${variant === 'compact' ? 'col-span-4' : 'col-span-3'} flex flex-col h-full`}>
          {/* Search */}
        ...
        {/* Main Chat Area */}
        <Card className={`${variant === 'compact' ? 'col-span-8' : 'col-span-9'} flex flex-col h-full`}>
          {/* Chat Header */}
