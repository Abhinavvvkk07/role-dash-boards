...
import { Bell, Mail, Shield, User, Moon, Sun, Monitor } from "lucide-react";
            ...
            <CardContent className="space-y-6">
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="email" type="email" placeholder="Your email" defaultValue="sarah@example.com" />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="role">Role</Label>
                  <Input id="role" disabled value="Management" />
                </div>
                <div className="space-y-2">
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <Label htmlFor="account">Account assignments</Label>
                    </div>
                    <div className="flex items-center space-x-2">
